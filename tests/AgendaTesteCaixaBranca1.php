 ...
 * Caminho: 1, 2, 3, 4, 5, 6, 7, 8, 4, 17, 18, 19, 23, 24, 25
 */

class AgendaTesteCaixaBranca1 extends TestCase {

    /** @test */
    public function testeConflitoDeDatas() {
        $lista_agenda = ['2021-04-27'];
        ...
        if (!empty($datas_conflitantes) && !empty($datas_sem_conflito)) {
            ...
            $conflitos = implode(", ", $datas_conflitantes);
            $this->assertEquals("2021-04-27", $conflitos);
            return $conflitos;
